...
public class Animal implements Competitor {
    ...
    public void info() {
        if(onDistance) {
            System.out.println(type + " " + name  + " преодолел полосу препятствий");
        } else {
            System.out.println(type + " " + name  + " не преодолел полосу препятствий");
        }
    }

    @Override
    public void infoAboutCompetitors() {
        System.out.println(type + " " + name + ": " + "макс. дистанция кросса - " + maxRunDistance + ", " +
